                ...
                <ul className="friend-grid">
                    ...
                    <form>
                        <div className="friend-name">Name:
                            <input value={this.state.name} onChange={this.changeName} name="name"  type="text" placeholder="name"/>
                        </div>
                        <div className="friend-age">Age:
                            <input value={this.state.age} onChange={this.changeName} name="age"  type="text" placeholder="age"/>
                        </div>
                        <div className="friend-email">Email:
                            <input value={this.state.email} onChange={this.changeName} name="email"  type="text" placeholder="email"/>
                        </div>
