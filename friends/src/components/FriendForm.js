        ...
        <div className="container">
            <form onSubmit={addNewFriend} className="form">
                <div className="form-inputs">
                    ...
                    <StyledInput type="text" name="age" placeholder="Age" value={friend.age} onChange={changeHandler} autoComplete="off"/>
                    <StyledInput type="text" name="email" placeholder="Email" value={friend.email} onChange={changeHandler} autoComplete="off"/>
                </div>
