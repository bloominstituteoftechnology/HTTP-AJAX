...
3.  In a separate terminal window, run `create-react-app friends` or if you didn't install it globally `npx create-react-app friends` to create your starter React application.
